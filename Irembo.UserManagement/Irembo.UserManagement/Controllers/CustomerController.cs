...
using Irembo.UserManagement.ViewModels;
...
namespace Irembo.UserManagement.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from Irembo.UserManagement", message);
