...
using Irembo.UserManagement.Authorization;
...
namespace Irembo.UserManagement
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //    options.UseNpgsql(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("Irembo.UserManagement")));
            
            var connectionString = Configuration["ConnectionStrings:DefaultConnection"];
            services.AddDbContext<ApplicationDbContext>(
                opts => opts.UseSqlite("Data Source=DBFileName.db")
            ) ;
            // add identity
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.DocumentTitle = "Swagger UI - Irembo.UserManagement";
